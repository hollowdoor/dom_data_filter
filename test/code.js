...
var df = new DataFilter('#test-list', {
    read: function read(){
...
df.element.addEventListener('beforetoggled', function (e){
    console.log('beforetoggled event');
});

df.element.addEventListener('toggled', function (e){
...
input.addEventListener('keydown', function (e){
    if(e.keyCode === 9){
        ...
        .then(function (val){ return input.value = val; });
